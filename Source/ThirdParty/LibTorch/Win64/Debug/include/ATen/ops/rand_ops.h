...
struct TORCH_API rand_names_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "rand.names_out(int[] size, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)")
...
struct TORCH_API rand_generator_with_names_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "rand.generator_with_names_out(int[] size, *, Generator? generator, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)")
