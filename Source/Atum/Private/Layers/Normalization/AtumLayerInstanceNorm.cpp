...
{
	Module = MakeShared<torch::nn::InstanceNorm1d>(std::make_shared<torch::nn::InstanceNorm1dImpl>(
...
{
	Module = MakeShared<torch::nn::InstanceNorm2d>(std::make_shared<torch::nn::InstanceNorm2dImpl>(
		static_cast<torch::nn::InstanceNormOptions>(Options)
	));
	return true;
}
...
{
	Module = MakeShared<torch::nn::InstanceNorm3d>(std::make_shared<torch::nn::InstanceNorm3dImpl>(
		static_cast<torch::nn::InstanceNormOptions>(Options)
	));
	return true;
}
